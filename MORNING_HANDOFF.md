...
- `npm run build -w @bing/client`：通过，有 Vite 大 chunk 警告，当前主要来自 Three.js/GLTF 相关体积。
- `npm run test:ui-agents`：通过。
  - 最新报告：`artifacts/playtests/ui-agents-2026-06-13T00-39-21-056Z/report.md`
  - 无 console error。
  - 无 failed action。
  - 无视觉 QA 告警。
